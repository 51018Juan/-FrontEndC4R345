...
function listar() {
    $.ajax({
        ...
        url: "http://152.67.44.23:8080/api/cleaningproduct/all",
...
function listarxPrecio() {
    ...
    if(!validaesVacio(precio)) {
        ...
        $.ajax({
            // la URL para la petición (url: "url al recurso o endpoint")
            url: `http://152.67.44.23:8080/api/cleaningproduct/price/${precio}`,
...
function listarxDescripcion() {
    ...
    if(!validaesVacio(descripcion)) {
        $.ajax({
            // la URL para la petición (url: "url al recurso o endpoint")
            url: `http://152.67.44.23:8080/api/cleaningproduct/description/${descripcion}`,
